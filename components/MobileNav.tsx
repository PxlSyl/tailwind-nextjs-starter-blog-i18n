...
const MobileNav = () => {
  ...
  return (
    <>
      ...
      <div
        className={`overflow-y-auto fixed left-0 top-0 z-10 h-full w-full transform bg-white opacity-95 duration-300 ease-in-out dark:bg-gray-950 dark:opacity-[0.98] ${
