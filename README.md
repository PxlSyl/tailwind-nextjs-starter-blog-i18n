...
However, this will require some additional configuration steps within other files (mainly files that are discussed in this article)
...
They are not differentiated within different folders (even if this could - and should - change in the future)
